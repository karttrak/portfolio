...
export default function CircleSvg(props: Props) {
  return (
    <svg className={props.className} fill="currentColor" strokeWidth="2" stroke="currentColor" strokeLinecap="round" viewBox="-16 -16 32 32" role="img" aria-labelledby="theme-toggle-sun" xmlns="http://www.w3.org/2000/svg">
